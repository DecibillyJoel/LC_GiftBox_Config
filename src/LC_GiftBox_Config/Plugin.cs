...
public class Plugin : BaseUnityPlugin
{
  ...
  private void Awake()
  {
    ...
    spawnStoreItemChance = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Behavior Selection", "Chance to select a store item (Selection Weight)", 60, new ConfigDescription("The selection weight of a gift box containing a store item. 0 = will not happen, larger selection weight = more likely to happen\n\n[Vanilla Value: 0]", new AcceptableValueRange<int>(0, 1000), [])));
    spawnScrapChance = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Behavior Selection", "Chance to select a scrap item (Selection Weight)", 35, new ConfigDescription("The selection weight of a gift box containing a scrap item. 0 = will not happen, larger selection weight = more likely to happen\n\n[Vanilla Value: 100]", new AcceptableValueRange<int>(0, 1000), [])));
    spawnGiftBoxChance = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Behavior Selection", "Chance to select another gift box (Selection Weight)", 1, new ConfigDescription("The selection weight of a gift box containing another gift box. 0 = will not happen, larger selection weight = more likely to happen\n\n[Vanilla Value: 0]", new AcceptableValueRange<int>(0, 1000), [])));
    spawnNothingChance = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Behavior Selection", "Chance to select no item (Selection Weight)", 4, new ConfigDescription("The selection weight of a gift box being empty. 0 = will not happen, larger selection weight = more likely to happen\n\n[Vanilla Value: 0]", new AcceptableValueRange<int>(0, 1000), [])));
    doNothingChance = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Behavior Selection", "Chance to leave gift box unmodified (Selection Weight)", 0, new ConfigDescription("The selection weight of a gift box not being modified by this mod, i.e. so another gift box mod's effects can function instead. 0 = will not happen, larger selection weight = more likely to happen\n\nIf you do not have any other gift box mods that function by transpiling OpenGiftBoxServerRpc(), I recommend leaving this value at 0. Otherwise, I recommend setting their probability values to 100% and this probability value to the weight you'd like to assign to the other mod, so that whenever this mod selects this hands-off behavior, the other mod's functionality will have a 100% chance to occur rather than simply using vanilla behavior", new AcceptableValueRange<int>(0, 1000), [])));
    ...
    scrapValueAdditionMin = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Scrap Item Value", "Minimum scrap item value addition", 30, new ConfigDescription("The minimum possible value of the multiplier applied to the selected scrap item's scrap value\n\n[Vanilla Value: 25]", new AcceptableValueRange<int>(-1000, 1000), [])));
    scrapValueAdditionMax = LethalConfigNicerizer.Nicerize(Config.Bind("Gift Box - Scrap Item Value", "Maximum scrap item value addition", 60, new ConfigDescription("The maximum possible value of the multiplier applied to the selected scrap item's scrap value\n\n[Vanilla Value: 35]", new AcceptableValueRange<int>(-1000, 1000), [])));
